  ...
  <q-page class="q-pa-sm">
    <div class="row q-col-gutter-sm flex flex-center">
      <div class="col-lg-8 col-md-8 col-xs-12 col-sm-12">
        <q-card class="card-bg text-primary no-shadow" bordered>
          ...
          <q-card-actions align="right">
            <q-btn class="text-capitalize bg-primary text-white" @click="updateUserInfo"
        ...
        <q-card class="card-bg text-white no-shadow" bordered>
          ...
          <q-card-section>
            <div class="text-body2 text-justify">
              ...
              programming since 2013, and then determined myself to become a skilled and
              knowledgeable programmer. My passion for my programming increases as I started working
              for Incentius (where I am currently working in).
            </div>
          </q-card-section>
        </q-card>
      </div> -->
...
export default defineComponent({
  ...
  setup() {
    ...
    const updateUserInfo = async () => {
      try {
        const response = await axios.put('localhost:9000/deneme', user_details.value)
